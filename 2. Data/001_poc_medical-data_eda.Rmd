                  ...
                  mutate(a_cat = 
                          case_when(
                            # reverse order at the moment
                             "train" ~ "Trainee involvement in ECRP",
                             "prophystent" ~ "Placement of Pancreatic Stent",
                             "amp" ~ "Ampullectomy",
                             "bsphinc" ~ "Theraputic Biliary Sphincterotomy",
                             "acinar" ~ "Pancreatic acinarisation",
                             #"" ~ "Therapeutic pancreatic schinterotomt",
                             "paninj" ~ "Pancreatography - Patients",
