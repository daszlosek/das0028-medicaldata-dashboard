...
# recpanc - Recurrent Pancreatitis, a risk factor for future PEP
...
# recreating table 1
indo_rct_long %>% group_by(rx,category,value) %>% count() %>%
                  ...
                  dplyr::select(category, ends_with("placebo"), ends_with("indomethacin"))
